...
void display()
{
	...
	glm::mat4 initTranslationY = glm::translate(glm::mat4(1.0), glm::vec3(0.f, -6.f, 0.f));
	...
	glm::mat4 matR = glm::rotate<float>(glm::mat4(1.0), angleRad, glm::vec3(0.0, 1.0, 0.0));
...
int main(int argc, char **argv) // Create Main Function For Bringing It All Together
{
	...
	window = glfwCreateWindow(width, height, "Bunny HOP", NULL, NULL);
